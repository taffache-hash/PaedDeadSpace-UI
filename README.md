...
## Screenshots
Release screenshots are intentionally captured only from the final tagged v1.0.0 UI. See `docs/screenshots/README.md` for the capture checklist; no mock-up or pre-release screenshots are substituted.
